...
name: kagi-search
description: |
  Use when you need web results: current information, documentation, news, research,
  or when the user says "search", "look up", "find out", "google". Not for one URL
  (kagi-summarize) and not for raw HTML (WebFetch).
allowed-tools: Bash
argument-hint: "<query>"
---
